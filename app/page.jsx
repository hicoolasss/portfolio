      ...
      <section className="flex-grow py-8 px-4 md:px-32 lg:px-64 md:mt-24">
        <div className={`${offBitRegular.className} text-7xl flex-col gap-5 hidden xl:flex`}>
          <div className='flex flex-row gap-5'>
            ...
            <p className={`${offBitDotBold.className} text-7xl`}> cool Websites: </p>
          </div>
          


          <div className='flex flex-row gap-5 relative'>
            {/* <Gauge className='w-16 h-16'></Gauge> */}
            
            <span
              className={`text-7xl relative ${isHoveredForFast ? `${offBitDotBold.className} drop-shadow-glow` : `${offBitBold.className}`}`}
            ...
            <motion.div
              className={`absolute -top-12 left-10 mt-5 opacity-0 rotate-15 filter-none`}
        ...
        <h1 className={`${offBitBold.className} text-4xl  md:text-7xl xl:hidden`}>
          ...
          <span className={`${offBitDot.className} `}> → </span>
