            ...
            <div className='mt-12 p-6 sm:p-0 sm:max-w-[500px] xl:max-w-none'>
              <div className={`${offBitRegular.className} text-7xl flex-col gap-5 hidden xl:flex `}>
                <div className='flex flex-row gap-5'>
                  ...
                  <div className={` -z-1 text-7xl relative ${isHovered ? `${offBitBold.className} drop-shadow-glow` : `${offBitDotBold.className}`}`} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                    Ideas
                    <motion.div className={` -z-1 absolute top-0 left-1/2 transform -translate-x-1/2 mt-[-0.5em] opacity-0 `} animate={animationControls}>
                      <div className=' -z-1 relative'>
                        <div className=" -z-1 absolute -inset-0.5 bg-warning rounded-lg blur-sm opacity-75 "></div>
                        <Lightbulb />
                      </div>
                    </motion.div>
                  </div>
                ...
                <div className='z-0  flex flex-row justify-around relative w-full'>
                  <div className={` z-0 text-7xl relative ${isHoveredForFast ? `${offBitDotBold.className} drop-shadow-glow` : `${offBitBold.className}`}`} onMouseEnter={handleMouseEnterForFast} onMouseLeave={handleMouseLeaveForFast}>
                    Fast
                    <motion.div className={`absolute -top-12 left-10 mt-5 opacity-0 rotate-15 filter-none`} animate={fastAnimationControls}>
                      <Image className=' z-0 rounded-lg' src="/resources/images/giphy.gif" alt="GIF" width={75} height={25} quality={100} />
                    </motion.div>
                  </div>
